...
void AAttackCharacter::ResetMontageState()
{
...
void AAttackCharacter::SetBlendOut_MontageName(FString name)
{
	currentToEndMontageName = name;
}

void AAttackCharacter::MyMontageBlendOut(UAnimMontage* Montage, bool bInterrupted)
{
